  ...
  return(
    <>
      ...
      <div className="flex flex-col justify-center items-center border-2 border-neutral-300 bg-neutral-100 shadow-xl/5 m-5 rounded-2xl p-2 mt-20">
        <h1 className="text-4xl font-extrabold text-neutral-600 text-center">Edit The Data</h1>
        <p className="text-xl font-extrabold text-neutral-400 text-center">Select a field to edit their data and supply</p>
        <Link to="EditGlobal">
          <button className="hover:text-emerald-500 hover:font-extrabold hover:border-2 hover:border-emerald-400 hover:bg-emerald-200 p-2 rounded-xl hover:scale-105 text-emerald-50 text-xl border-emerald-50 bg-emerald-500 duration-200 ease-(--my-beizer) m-5">Edit Global Parameters</button>
        </Link>

        <div className="flex flex-col border-2 border-neutral-300 m-2 rounded-2xl p-2">
          <h1 className="text-4xl font-extrabold text-neutral-600 text-center">Farmer Data</h1>
          <div className="flex flex-row justify-around ">
            {
              ...
              <Link to='/Assignment/Initialization/CreateFarmer' className="hover:text-blue-500 hover:font-extrabold hover:border-2 hover:border-blue-400 hover:bg-blue-200 p-2 rounded-xl hover:scale-105 text-blue-50 text-xl border-blue-50 bg-blue-500 duration-200 ease-(--my-beizer) h-fit self-center pt-10 pb-10 m-5">Add Farmer</Link>
          </div>
        </div>

        <div className='flex flex-col border-2 border-neutral-300 m-2 rounded-2xl p-2'>
          <h1 className="text-4xl font-extrabold text-neutral-600 text-center">Buyer Data</h1>
          <div className="flex flex-row justify-around">
            {
              ...
              <Link to='/Assignment/Initialization/CreateBuyer' className="hover:text-blue-500 hover:font-extrabold hover:border-2 hover:border-blue-400 hover:bg-blue-200 p-2 rounded-xl hover:scale-105 text-blue-50 text-xl border-blue-50 bg-blue-500 duration-200 ease-(--my-beizer) h-fit self-center pt-10 pb-10 m-5">Add Buyer</Link>
          </div>
        </div>
