...
function Members() {
  ...
  const Members = [
    ...
    {name:"Luiz Dela Cruz", picture:"about-us/group_members/dela_cruz.png", url:"https://www.facebook.com/luismigueldlcrz"},
    {name:"Eric Samilliano", picture:"about-us/group_members/samilliano.png", url: "https://www.facebook.com/luismigueldlcrz"}
  ]
  return (
    <>
